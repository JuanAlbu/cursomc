...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maraia@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PPENDENTE, ped2, sdf.parse("20/10/2017 00:00"), null);
